...
export default function PropertyForm({ initialData, onSubmit, submitLabel = "Save Property" }) {
  ...
  const inputClass =
    "w-full rounded-xl border border-slate-200 bg-white px-4 py-2.5 mt-5 text-sm text-slate-900 placeholder:text-slate-400 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20";
