      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-20 grid grid-cols-1 gap-12 md:grid-cols-12">
          <div className="md:col-span-5 md:pr-4 lg:pr-10">
            <h3 className="mb-2 text-[20px] font-bold tracking-tight">
              Stay in the loop
            </h3>
            <p className="mb-8 text-[13px] font-medium text-slate-300">
          ...
          <div className="grid grid-cols-2 gap-8 md:col-span-6 lg:grid-cols-3">
            {Object.entries(footerLinks).map(([category, items]) => (
              <div key={category}>
                <h3 className="mb-5 text-[15px] font-bold tracking-tight">
                  {category}
                </h3>
            ...
            <div>
              <h3 className="mb-5 text-[15px] font-bold uppercase tracking-tight">
                Contact Us
              </h3>
        ...
        <div className="flex flex-col items-start justify-between gap-10 md:flex-row lg:items-end">
          <div className="mt-4 w-full max-w-3xl border-t border-slate-800 pt-8 md:mt-0 md:border-t-0 md:pt-0">
            ...
            <p className="mb-7 text-[13px] font-semibold tracking-wide text-white">
              Copyright 2026 Grove Vista Properties
            </p>

            <p className="max-w-[800px] text-[11.5px] font-medium leading-relaxed text-slate-500">
              Grove Vista Properties Real Estate Broker is a company registered
              in Mumbai, Maharashtra, India (Registration No. XXXXXXXX), 36th
              Floors, Business Tower, Andheri East, Mumbai - 400069. We are
              regulated under RERA with registration number XXXXXXXX.
            </p>
          </div>
        </div>
      </div>
