...
const contactCards = [
  {
    ...
    href: "https://wa.me/919999999999?text=Hi%20I%20am%20interested%20in%20your%20services",
  ...
  {
    label: "Email",
    value: "info@grovevistaproperties.com",
    href: "mailto:info@grovevistaproperties.com",
...
export default function ContactSection() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setSubmitMessage(result?.message || "Your details were submitted successfully.");
  ...
  return (
    <section id="contact" className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-100 py-24">
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-16 px-6 md:grid-cols-2">
        <div>
          <p className="mb-4 text-sm font-bold uppercase tracking-widest text-blue-600">Get in Touch</p>
          <h2 className="mb-6 text-4xl font-extrabold leading-tight text-slate-900 md:text-5xl">Speak with our Property Specialists Today</h2>
          <p className="mb-12 text-lg font-medium leading-relaxed text-slate-600">
            Get in touch for tailored guidance from our expert team. We are committed to assisting you through every step of your journey in the
    ...
    >
      ...
      <div className="flex flex-col">
        ...
        <span className="text-[14px] font-medium text-blue-600 transition-colors group-hover:text-blue-800">
          ...
          <div className="mt-10">
            <p className="mb-3 text-[13px] font-bold uppercase tracking-wider text-slate-500">Follow us</p>
        ...
        <div className="rounded-[2rem] border border-white/80 bg-white/60 p-10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] backdrop-blur-2xl">
          <h3 className="mb-8 text-2xl font-extrabold text-slate-900">Send us a message</h3>

          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
              <div>
                <label className="mb-2 block text-[11px] font-bold uppercase tracking-widest text-slate-500">First Name</label>
                <input
                  type="text"
                  name="firstName"
                  placeholder="John"
              ...
              <div>
                <label className="mb-2 block text-[11px] font-bold uppercase tracking-widest text-slate-500">Last Name</label>
                <input
                  type="text"
                  name="lastName"
                  placeholder="Doe"
            ...
            <div>
              <label className="mb-2 block text-[11px] font-bold uppercase tracking-widest text-slate-500">Email Address</label>
              <input
                type="email"
                name="email"
            ...
            <div>
              <label className="mb-2 block text-[11px] font-bold uppercase tracking-widest text-slate-500">Phone Number</label>
              <input
                type="text"
                name="phone"
            ...
            <div>
              <label className="mb-2 block text-[11px] font-bold uppercase tracking-widest text-slate-500">Message</label>
              <textarea
                rows={4}
                name="message"
            ...
            {submitMessage ? (
              <p className={`text-center text-[12.5px] font-medium ${submitStatus === "success" ? "text-green-600" : "text-red-600"}`}>
                {submitMessage}
              </p>
            ) : null}
            ...
            <p className="pt-2 text-center text-[11.5px] font-medium text-slate-500">
              ...
              <Link href="/" className="ml-1 font-bold text-blue-600 hover:underline">
